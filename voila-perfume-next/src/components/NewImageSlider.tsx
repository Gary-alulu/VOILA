        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
             <div className="w-fit flex flex-col items-center">
               ...
               <div className="mt-8 flex items-center bg-white bg-opacity-20 backdrop-filter backdrop-blur-md rounded-full p-2 shadow-lg w-11/12 md:w-3/4 lg:w-1/2" >
              <div className="px-3">
              ...
              <input
                type="text"
                placeholder="Search"
                className="flex-grow bg-transparent text-white placeholder-white outline-none text-sm md:text-base"
              />
