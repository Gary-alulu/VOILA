        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <Link href="#" className="text-mistGray hover:text-imperialGold transition-colors transform hover:scale-110 dark:text-cloudedPearl dark:hover:text-imperialGold">
              ...
              <Link href="#" className="text-mistGray hover:text-imperialGold transition-colors dark:text-cloudedPearl dark:hover:text-imperialGold">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">New Arrivals</Link></li>
              <li><Link href="#" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">Gift Sets</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/blog-stories" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">Blog & Stories</Link></li>
              <li><Link href="#" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">FAQs</Link></li>
              <li><Link href="#" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">Scent Guide</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about#our-story" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">Our Story</Link></li>
              <li><Link href="#" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">Our Craft</Link></li>
              <li><Link href="#" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">Sustainability</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/contact" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">Get in Touch</Link></li>
              <li><AnimatedLink href="#" hoverEffect="scale">
                <span className="sr-only">Instagram</span>
                {/* SVG content */}
              </AnimatedLink></li>
              <li><Link href="#" className="text-mistGray hover:text-imperialGold transition-colors transform hover:translate-x-1 dark:text-cloudedPearl dark:hover:text-imperialGold">Pinterest</Link></li>
            </ul>
          </div>
        </div>
      </div>
